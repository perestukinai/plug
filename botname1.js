/**
 ...
 This software is not for profit, any extension, or unauthorised person providing this software is not authorised to be in a position of any monetary gain from this use of this software. Any and all money gained under the use of the 

software (which includes donations) must be passed on to the original author.
...
(function () {
   ...
   if (password==pass1)
     alert('Slaptažodis teisingas!');
      ...
      {
      window.location='https://plug.dj/juodi-debesys';
      };
*/
    ...
    var basicBot = {
        ...
        settings: {
            ...
            scriptLink: 'https://rawgit.com/perestukinai/plug/master/botname3.js',
            ...
            motdEnabled: true,
            motdInterval: 7,
            motd: 'DISCORD Juodi Debesys, pokalbiai prieinami visiems! - https://discord.gg/XQ6Jq // Iškritai iš DJ eilės? Rašyk !dc sugrįžimui. ',
            filterChat: true,
            etaRestriction: true,
            welcome: true,
            opLink: 'nėra draudžiamų dainu',
            rulesLink: 'https://goo.gl/Ygsx9p',
            themeLink: null,
            fbLink: 'https://www.facebook.com/Juodi-Debesys-1560168277619765/',
            discordLink: 'https://discord.gg/XQ6Jq',
            twitter: null,
            intervalMessages: ['@staff Visi prisijungę administratoriai taip pat ir RDJ turi būti prisijungę ir DISCORD programoje https://discord.gg/XQ6Jq'],
            messageInterval: 4,
            songstats: true,
            commandLiteral: '!',
            blacklists: {
                NSFW: 'https://rawgit.com/perestukinai/plug/master/NSFW.json',
                OP: 'https://rawgit.com/perestukinai/plug/master/OP.json',
                BANNED: 'https://rawgit.com/perestukinai/plug/master/BANNED.json'
            }
        },
        room: {
            name: "Juodi Debesys",
        ...
        chatUtilities: {
            chatFilter: function(chat) {
                ...
                if (msg.indexOf('Sveiki atvykę') > -1 || msg.indexOf('Pagaliau sugrįžai') > -1 || msg.indexOf('|') > -1) {
                    setTimeout(function(id) {
                ...
                if (msg.indexOf('autojoin was not enabled') > 0 || msg.indexOf('AFK message was not enabled') > 0 || msg.indexOf('!afkdisable') > 0 || msg.indexOf('!joindisable') > 0 || msg.indexOf('autojoin disabled') > 0 || 
...
msg.indexOf('AFK message disabled') > 0) {
            ...
            curses: [ 
                'atmata', 'acypisi', 'atcypisi', 'acypisat', 'atsipisi', 'atsipisk', 'bibis', 'blet', 'bbd', 'blt', 'bybi', 'bybys', 'ciulpk', 'cbb', 'ciulpk', 'čiulpk', 'čiulpk bybi', 'duhas', 'dūhas', 'faggot', 'fck', 'fuck', 

'gandonas', 'krv', 'krw', 'kurva', 'kurwa', 'kūrva', 'modafocka', 'motherfucker', 'nahoi', 'nahui', 'nigga', 'nigger', 'niqqa', 'nx', 'nachui', 'pederastas', 'pedikas', 'pedofilas', 'pidar', 'pisk nx', 'pisk nx', 'pisk', 'pohui', 'pusk 

nx', 'px', 'pydaras', 'pūsk nx', 'uzsikrusk', 'užsikrušk', 'užsipisk'
            ]
        },
        connectAPI: function() {
            this.proxy = {
            ...
            shushCommand: {
                ...
                functionality: function(chat, cmd) {
                    ...
                    if (!bot.commands.executable(this.rank, chat))
                        ...
                        API.sendChat('@' + name + ' https://i.imgur.com/IrW7uzy.png');
